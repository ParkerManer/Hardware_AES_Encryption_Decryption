...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { send }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { out_tx }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports {  data_out_tx}]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
#et_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { data_out_tx }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
...
#set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { out_tx }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
